...
if(isset($_POST['reg-email'])){
    ...
    $email = !empty($_POST['reg-email']) ? test_input($_POST['reg-email']) : null;
    ...
    $password1 = !empty($_POST['reg-password']) ? test_input($_POST['reg-password']) : null;
    ...
    if($row['num'] > 0){
        array_push($errors, "This email is associated with an existing user!!");
    }
